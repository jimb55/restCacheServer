...
if(Capsule::table('cars')->insert(["name" => generateName(),"email" => generateName()."@".generateName(4).".gmail"]) && Capsule::table('companys')->insert(["name" => generateName(),"email" => generateName()."@".generateName(4).".gmail"])){
